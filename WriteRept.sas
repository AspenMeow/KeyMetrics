...
Font = (“Arial, Helvetica”, 6pt, bold );
 replace fonts /
 /*'TitleFont' = ("Times Roman",11pt,Bold ) Titles from TITLE statements */
/* 'TitleFont2' = ("Times Roman",12pt,Bold ) /* Proc titles ("The XX Procedure")*/
'StrongFont' = ("Times Roman",10pt,Bold)
'EmphasisFont' = ("Times Roman",10pt,Italic)
'headingEmphasisFont' = ("Times Roman",11pt,Bold Italic)
'headingFont' = ("Times Roman",9pt,Bold) /* Table column and row headings */
'docFont' = ("Arial",10pt) /* Data in table cells */
'footFont' = ("Calibri",6pt) /* Footnotes from FOOTNOTE statements */
...
%macro ppsmetric;
	%do k=1 %to &collcnt;
		...
		proc report data= ds  style(report)={outputwidth=100%};
		...
		define V2/display "Admin Based SCH per Rank Fac FY &V2yr" format=comma15.1 style(column)=[width=8%];
 ...
 compute V1;
     if V1 lt &PSV133_3 & V1 ne . then call define(_col_,"style","style={background=#99d8c9}");
 ...
 compute V2;
	 ...
	 else if V2 gt &PSV266_6 & V2 ne . then call define(_col_,"style","style={background=#99d8c9}");
 ...
 compute V3;
	 ...
	 else if V3 gt &PSV366_6 & V3 ne . then call define(_col_,"style","style={background=#99d8c9}");
 ...
 compute V4;
	 ...
	 else if V4 gt &PSV466_6 & V4 ne . then call define(_col_,"style","style={background=#99d8c9}");
 ...
 compute V5;
	 ...
	 else if V5 gt &PSV566_6 & V4 ne . then call define(_col_,"style","style={background=#99d8c9}");
...
proc report data= aa  split='~'  spanrows style(report)={outputwidth=100%};
...
define TAXONOMY/display   'Taxonomy' style(column)=[cellwidth=9%]  ;
...
define RANK_SCHLR_RSCH_INDEX1/display 'FPSI Rank' format=comma10.2;
...
compute PCT_JOURNAL_PUBS_PER_FACULTY1;
	 ...
	 else if PCT_JOURNAL_PUBS_PER_FACULTY1 gt &JP66_6 & PCT_JOURNAL_PUBS_PER_FACULTY1 ne . then call define(_col_,"style","style={background=#99d8c9}");
 ...
 compute PCT_CITATIONS_PER_FACULTY1;
	 ...
	 else if PCT_CITATIONS_PER_FACULTY1 gt &CF66_6 & PCT_CITATIONS_PER_FACULTY1 ne . then call define(_col_,"style","style={background=#99d8c9}");
 ...
 compute PCT_CITATIONS_PER_PUBLICATION1;
	 ...
	 else if PCT_CITATIONS_PER_PUBLICATION1 gt &CP66_6 & PCT_CITATIONS_PER_PUBLICATION1 ne . then call define(_col_,"style","style={background=#99d8c9}");
 ...
 endcomp;
  compute PCT_GRANTS_PER_FACULTY1;
	 ...
	 else if PCT_GRANTS_PER_FACULTY1 gt &GF66_6 & PCT_GRANTS_PER_FACULTY1 ne . then call define(_col_,"style","style={background=#99d8c9}");
 ...
 endcomp;
  compute PCT_GRANT_DOLLARS_PER_FACULTY1;
	 ...
	 else if PCT_GRANT_DOLLARS_PER_FACULTY1 gt &GDF66_6 & PCT_GRANT_DOLLARS_PER_FACULTY1 ne . then call define(_col_,"style","style={background=#99d8c9}");
 ...
 endcomp;
  compute PCT_DOLLARS_PER_GRANT1;
	 ...
	 else if PCT_DOLLARS_PER_GRANT1 gt &DG66_6 & PCT_DOLLARS_PER_GRANT1 ne . then call define(_col_,"style","style={background=#99d8c9}");
 ...
 endcomp;
  compute PCT_AWARDS_PER_FACULTY1;
	 ...
	 else if PCT_AWARDS_PER_FACULTY1 gt &AF66_6 & PCT_AWARDS_PER_FACULTY1 ne . then call define(_col_,"style","style={background=#99d8c9}");
...
proc report data= pag  split='~'  spanrows style(report)={outputwidth=100%};
...
compute PERSIST1;
	 ...
	 else if PERSIST1 gt &P166_6 & PERSIST1 ne . then call define(_col_,"style","style={background=#99d8c9}");
 ...
 compute PERSIST2;
	 ...
	 else if PERSIST2 gt &P266_6 & PERSIST2 ne . then call define(_col_,"style","style={background=#99d8c9}");
 ...
 compute PERSIST3;
	 ...
	 else if PERSIST3 gt &P366_6 & PERSIST3 ne . then call define(_col_,"style","style={background=#99d8c9}");
...
compute GRAD4;
	 ...
	 else if GRAD4 gt &G466_6 & GRAD4 ne . then call define(_col_,"style","style={background=#99d8c9}");
 ...
 compute GRAD5;
	 ...
	 else if GRAD5 gt &G566_6 & GRAD5 ne . then call define(_col_,"style","style={background=#99d8c9}");
 ...
 endcomp;
  compute GRAD6;
	 ...
	 else if GRAD6 gt &G666_6 & GRAD6 ne . then call define(_col_,"style","style={background=#99d8c9}");
...
proc report data= pagdg  split='~'  spanrows ;
...
compute TTD;
     if TTD lt &TTD33_3 & TTD ne . then call define(_col_,"style","style={background=#99d8c9 }");
...
ods listing close;
ods pdf file="O:\IS\Internal\Reporting\Annual Reports\Key Metrics Set\Data\KeyMetricsOrgSet.pdf" style=Custom;
%ppsmetric;
ods pdf close;
